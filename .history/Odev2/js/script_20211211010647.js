...
//   var toastElList = [].slice.call(document.querySelectorAll(status));
//   var toastList = toastElList.map(function (toastEl) {
//     return new bootstrap.Toast(toastEl);
//   });
//   toastList.forEach((toast) => toast.show());
    let toast = document.querySelectorAll(status)
    console.log(toast)
    let ss = function(toast){
        return new new bootstrap.Toast(toast)
    }
    ss.show()
}
function newElement() {
